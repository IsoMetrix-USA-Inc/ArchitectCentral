    ...
    public class QueryOptimizerService
    {
        ...
        public OptimizedQuery OptimizeQuery(string originalQuery, string? conversationContext = null)
        {
            ...
            if (_config.EnableQueryExpansion)
            {
                ...
                if (optimized.ExpandedTerms.Any())
                {
        ...
        /// </summary>
        private SearchStrategy DetermineSearchStrategy(QueryType queryType)
        {
        ...
        /// </summary>
        private string ApplyExpansions(string query, List<QueryExpansion> expansions)
        {
            var processed = query;
        ...
        /// </summary>
        private string ExpandVagueTerms(string query)
        {
        ...
        /// </summary>
        private string AddDomainContext(string query)
        {
            var queryLower = query.ToLowerInvariant();
        ...
        /// </summary>
        private List<FilterSuggestion> SuggestFilters(string query)
        {
